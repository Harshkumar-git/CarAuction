...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" import="java.io.*" import="java.sql.*" %>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <nav class="main-nav">
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="#">Auctions</a>
                            <ul>
                                <li><a href="<%=request.getContextPath() %>/Auction?actionCode=getcarname">Create Auction</a></li>
                          <li>    <a href="<%=request.getContextPath() %>/Auction?actionCode=viewAuction">View Auction</a> </li>
                        ...
                        <li>
                         <a href="<%=request.getContextPath()%>/registration?actionCode=logout"><span class="ion-log-out" style="font-weight: bold">Logout</span></a>       
                        </li>
                    </ul>
                </nav> <!-- end .main-nav -->
